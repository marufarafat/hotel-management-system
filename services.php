				...
				<div class="row inn-page-com">
					...
					<div class="col-md-12">
						<div class="row inn-services in-blog">
							<div class="col-md-4"> <img src="images/ami/7.jpg" alt="" /> </div>
							<div class="col-md-8">
								...
								<p>Praesent gravida, sapien vitae accumsan aliquet, tellus mi euismod turpis, in mollis odio tellus et justo. Nullam auctor lorem ac mauris ullamcorper varius. </p> <a href="#" class="waves-effect waves-light inn-re-mo-btn">Read More</a> </div>
						</div>
						<div class="row inn-services in-blog">
